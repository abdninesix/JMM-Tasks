        ...
        <div className="relative w-full max-w-md" ref={comboBoxRef}>
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full pl-8 py-2.5 pr-12 border border-input dark:border-input dark:bg-input/30 dark:hover:bg-input/50 text-foreground dark:text-foreground text-sm rounded-md focus:outline-none focus:ring-2 focus:ring-theme1 focus:border-transparent placeholder-gray-500 dark:placeholder-gray-400"
                    role="combobox"
