        ...
        <div className='h-screen flex p-4 overflow-hidden'>
            ...
            <section className='h-full w-full lg:w-1/2 flex flex-col p-4 justify-between'>
                ...
                <footer className='flex flex-col-reverse md:flex-row items-center justify-between gap-2 text-sm text-gray-600 font-semibold'>
                    ...
                    <a href='mailto:sales@hysabat.com' className='flex gap-1'><Mail className='text-xl' /> sales@hysabat.com</a>
                </footer>
            </section>

            {/* Right section */}
            <section className='w-full lg:w-1/2 hidden lg:flex flex-col items-center p-20 justify-center bg-linear-to-br from-sky-400 to-blue-950 rounded-2xl'>
                {/* Image */}
                <div>
