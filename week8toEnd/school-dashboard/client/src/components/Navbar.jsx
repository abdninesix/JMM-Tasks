    ...
    return (
        <nav className="paddingClass flex w-full items-center justify-between">
            ...
            <div className="flex gap-4">
                ...
                {user?.role === "Admin" &&
                    <Link to="/admin/users" className="rounded bg-theme px-4 py-2 font-semibold text-white duration-100 hover:bg-theme/80 active:scale-90">All Users</Link>
                }


                {user ?
                    <>
                        <Link to="/dashboard" className="rounded bg-theme px-4 py-2 font-semibold text-white duration-100 hover:bg-theme/80 active:scale-90">Dashboard</Link>
