  ...
  return (
    <aside className="sticky left-0 top-4 flex h-[80vh] min-w-60 flex-col justify-between rounded-lg bg-theme/80 p-4 text-lg font-semibold text-white shadow">
      <div className="flex flex-col gap-2">
        <Link
          to="/"
          className="flex items-center gap-3 rounded px-4 py-2 duration-100 hover:bg-white/20 active:scale-95"
        >
          <FaHome />
          <span>Home</span>
        </Link>
      ...
      <div className="flex flex-col gap-2 border-t pt-4">
        ...
        <button
          ...
          className="flex items-center gap-3 cursor-pointer rounded px-4 py-2 text-left bg-red-400 duration-100 hover:opacity-80 active:scale-95"
        >
          <FaSignOutAlt />
          <span>Sign Out</span>
